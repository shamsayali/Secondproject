...
<div class="row">
    <div class="col-sm-12">
     <table class="table table-bordered">
        ...
        <tr>
            <td>V.B NET CONTROLL STRUCTURE</td>
            <td>ITT 05201</td>
        ...
        <tr>
            <td>INFORMATION PRESENTATION AND DATA PROCESSING</td>
            <td>ITT 05204</td>
        ...
        <tr>
            <td>PC HARDWARE AND MAINTAINANCE</td>
            <td>ITT 05205</td>

        </tr>
        <tr>
            <td>INFORMATION SYSTEM DESING</td>
            <td>ITT 05207</td>

        </tr>
        <tr>
            <td>ACADEMIC WRITTING AND SKILLS</td>
            <td>ITT 06208</td>

        </tr>
        <tr>
            <td>BUDGETING AND INVESTMENT</td>
            <td>ITT 06208</td>
